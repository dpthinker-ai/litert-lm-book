...
- [第三部分 · 资源管理与推理优化](parts/part03-runtime-optimization.md)
  ...
  - [第 10 章 端侧 MoE：稀疏激活、专家执行与内存管理](chapters/ch10-moe/chapter.md)
    - [10.1　总参数与激活参数]()
    - [10.2　一次 MoE 前向计算]()
    - [10.3　容量、计算与访问成本]()
...
- [第四部分 · 多模态、工具调用与跨语言集成](parts/part04-capabilities-integration.md)
  - [第 11 章 多模态与工具调用：视觉/音频编码、约束解码与函数调用](chapters/ch11-multimodal/chapter.md)
  ...
  - [第 12 章 多语言绑定：C ABI、JNI 与 Embind](chapters/ch12-bindings/chapter.md)
