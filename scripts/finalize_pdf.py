...
UNITS = [
    ("前言",                                    r"^\s*前言\s*$",              None,                 "前言"),
    ("第 1 章 端侧 LLM：三堵墙与一张版图",       r"^\s*第\s*1\s*章",          "第一部 · 起点",       "第 1 章 三堵墙"),
    ("第 2 章 跑起来与鸟瞰",                     r"^\s*第\s*2\s*章",          "第一部 · 起点",       "第 2 章 跑起来与鸟瞰"),
    ("第 3 章 输入之路：从 Engine API 到 token 序列", r"^\s*第\s*3\s*章",      "第二部 · 一个 token 的一生", "第 3 章 输入之路"),
    ("第 4 章 Prefill：吞下提示词",              r"^\s*第\s*4\s*章",          "第二部 · 一个 token 的一生", "第 4 章 Prefill"),
    ("第 5 章 Decode：逐 token 的心跳",          r"^\s*第\s*5\s*章",          "第二部 · 一个 token 的一生", "第 5 章 Decode"),
    ("第 6 章 KV cache 与会话状态",              r"^\s*第\s*6\s*章",          "第三部 · 快的代价",   "第 6 章 KV cache"),
    ("第 7 章 模型的形态：量化、.litertlm 格式与 LoRA", r"^\s*第\s*7\s*章",     "第三部 · 快的代价",   "第 7 章 模型的形态"),
    ("第 8 章 异构算力：CPU、GPU 与 NPU",        r"^\s*第\s*8\s*章",          "第三部 · 快的代价",   "第 8 章 异构算力"),
    ("第 9 章 一次前向，多个 token：推测解码与 MTP", r"^\s*第\s*9\s*章",       "第三部 · 快的代价",   "第 9 章 推测解码"),
    ("第 10 章 不止聊天：多模态、约束解码与 Tool Use", r"^\s*第\s*10\s*章",    "第四部 · 能力与工程", "第 10 章 多模态与工具"),
    ("第 11 章 一套核心，六种语言",              r"^\s*第\s*11\s*章",         "第四部 · 能力与工程", "第 11 章 六种语言"),
