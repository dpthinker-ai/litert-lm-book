...
> 全稿已成：前言、12 章、尾声、附录 A-E，40 张 SVG。已发布书稿基线为 Tag v0.3.1（源码分析为 v0.17.0）；源码分析锚定 release/v0.17.0 对应的冻结 tag，第 10 章 MoE 接续 MTP，作为第三部分末章。开放项见下文“当前实测与开放项”。
...
- 第 10 章　端侧 MoE：稀疏激活、专家执行与内存核算——Gemma 4 参数与访问成本核算、专家分派、CPU/GPU 源码、数值对照与完整模型部署
