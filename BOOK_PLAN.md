...
> **v4.3（2026-07-17）：扩容工程启动（目标 ~250 页）**。学习网站借鉴落地：图 2-3 端到端数据流（SVG 重制为书版）、术语表 4 增 1 修、附录 B 读码路径。Tier 1 补欠账：7 张权衡表（3-1/4-1/7-1/8-1/9-1/10-1/11-1）与 6 张缺口图（5-2/6-3/7-2/8-2/9-2/10-2）全部补齐。仍开放：ch01 收益动机与小结、ch03 EngineFactory、ch07 weight cache、ch11 Copybara、未做实验 4 个（T1c/T1d）、附录 G/H 与尾声扩写（T2）、正文深潜（T3）。
